                        ...
                        <div class="col-sm-4">
                            <div class="card">
                                <div class="p-2 text-center card-body">
                                    ...
                                    <div class="m-0 h1">43</div>
                                    <div class="mb-3 text-muted">New Tickets</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="card">
                                <div class="p-2 text-center card-body">
                                    ...
                                    <div class="m-0 h1">95</div>
                                    <div class="mb-3 text-muted">Daily Earnings</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="card">
                                <div class="p-2 text-center card-body">
                                    ...
                                    <div class="m-0 h1">7</div>
                                    <div class="mb-3 text-muted">New Replies</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter">
                                <tr>
                                    <td class="w-1 pe-0">
                                        <input type="checkbox" class="m-0 align-middle form-check-input"
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                <thead>
                                    <tr>
                                        <th class="w-1"><input class="m-0 align-middle form-check-input"
                                ...
                                <tbody>
                                    <tr>
                                        <td><input class="m-0 align-middle form-check-input" type="checkbox"
                                        ...
                                        <td class="text-end">
                                            <span class="dropdown">
                                                <button class="align-text-top btn dropdown-toggle"
