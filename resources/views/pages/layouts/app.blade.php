...
<head>
    ...
    <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72"
        href="asets/img/apple-touch-icon-72x72-precomposed.png">
...
<body class="datepicker_mobile_full">
    ...
    <header class="reveal_header">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-6">
                    <a href="index.html" class="logo_normal"><img src="assets/img/logo.png" width="135"
                            height="45" alt=""></a>
                    <a href="index.html" class="logo_sticky"><img src="assets/img/logo_sticky.png" width="135"
                            height="45" alt=""></a>
                </div>
                <div class="col-6">
                    <nav>
    ...
    <div class="nav_panel">
        ...
        <div class="logo_panel"><img src="assets/img/logo_sticky.png" width="135" height="45" alt="">
        </div>
        <div class="sidebar-navigation">
            <nav>
                ...
                <div class="panel_footer">
                    <div class="phone_element"><a href="tel://423424234"><i
    ...
    <main>
                ...
                <div class="row justify-content-between flex-lg-row-reverse align-items-center">
                    <div class="col-lg-5">
                        <div class="parallax_wrapper">
                            <img src="assets/img/home_2.jpg" alt="" class="img-fluid rounded-img">
                            <div data-cue="slideInUp" class="img_over"><span data-jarallax-element="-30"><img
                                        src="assets/img/home_1.jpg" alt="" class="rounded-img"></span></div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="intro">
            ...
            <div class="pinned-image pinned-image--medium">
                <div class="pinned-image__container" id="section_video">
                    <video loop="loop" muted="muted" id="video_home">
                        <source src="assets/video/swimming_pool_2.mp4" type="video/mp4">
                        <source src="assets/video/swimming_pool_2.webm" type="video/webm">
                        <source src="assets/video/swimming_pool_2.ogv" type="video/ogg">
                    </video>
            ...
            <div class="row justify-content-center add_bottom_90" data-cues="slideInUp" data-delay="300">
                <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
                    <a href="room-details.html" class="box_cat_rooms">
                        <figure>
                            <div class="background-image" data-background="url(assets/img/rooms/1.jpg)"></div>
                            <div class="info">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <a href="room-details.html" class="box_cat_rooms">
                        <figure>
                            <div class="background-image" data-background="url(assets/img/rooms/2.jpg)"></div>
                            <div class="info">
            ...
            <div class="container margin_120_95">
                    ...
                    <div class="col-lg-6">
                        <div class="pinned-image rounded_container pinned-image--small mb-4">
                            <div class="pinned-image__container">
                                <img src="assets/img/local_amenities_1.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                ...
                <div class="row justify-content-between d-flex align-items-center">
                    <div class="col-lg-6 order-lg-2">
                        <div class="pinned-image rounded_container pinned-image--small mb-4">
                            <div class="pinned-image__container">
                                <img src="assets/img/local_amenities_3.jpg" alt="">
                            </div>
                        </div>
                    </div>
        ...
        <div class="parallax_section_1 jarallax" data-jarallax data-speed="0.2">
            <img class="jarallax-img kenburns-2" src="assets/img/hero_home_1.jpg" alt="">
                            ...
                            <div class="carousel_testimonials owl-carousel owl-theme nav-dots-orizontal">
                                <div>
                                    <div class="box_overlay">
                                        <div class="pic">
                                            <figure><img src="assets/img/testimonial_1.jpg" alt=""
                                                    class="img-circle">
                                            </figure>
                ...
                <div class="row justify-content-center home">
                    <div class="item col-xl-4 col-lg-6">
                        <a href="news-post.html" class="box_contents" data-cue="slideInUp" data-delay="300">
                            <figure><img src="assets/img/blog-1.jpg" alt="" class="img-fluid"><em>11 Dec</em>
                            </figure>
                            <div class="wrapper">
                    ...
                    <div class="item col-xl-4 col-lg-6">
                        <a href="news-post.html" class="box_contents" data-cue="slideInUp" data-delay="400">
                            <figure><img src="assets/img/blog-3.jpg" alt="" class="img-fluid"><em>24 Dec</em>
                            </figure>
                            <div class="wrapper">
                    ...
                    <div class="item col-xl-4 col-lg-6">
                        <a href="news-post.html" class="box_contents" data-cue="slideInUp" data-delay="500">
                            <figure><img src="assets/img/blog-2.jpg" alt="" class="img-fluid"><em>21 Dec</em>
                            </figure>
                            <div class="wrapper">
